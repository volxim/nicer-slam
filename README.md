...
Install third-party repositories for monocular depth/normal estimation and optical flow extraction. (Still Download GMFlow's pretrained models manually)

```
bash scripts/ThirdPartySetup.sh
```
